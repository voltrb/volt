if RUBY_PLATFORM != 'opal'
  ...
  describe Volt::AssetFiles do
    ...
    it 'should list all JS files' do
      ...
      expect(main.javascript_files(nil)).to eq(['/assets/js/jquery-2.0.3.js', '/assets/js/mutation_observer_polyfill.js', '/assets/js/volt_js_polyfills.js', '/assets/js/volt_watch.js', '/assets/js/bootstrap.js', '/assets/js/test2.js', '/assets/js/test3.js', '/assets/js/test1.js', '/assets/volt/page/page.js', '/components/main.js'])
    end

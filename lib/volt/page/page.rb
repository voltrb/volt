...
require 'volt/page/attribute_binding'
require 'volt/page/content_binding'
require 'volt/page/each_binding'
require 'volt/page/if_binding'
require 'volt/page/template_binding'
require 'volt/page/template_renderer'
require 'volt/page/reactive_template'
require 'volt/page/event_binding'
